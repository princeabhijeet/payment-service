    ...
    stages {
        stage('SCM Checkout') {
            steps {
                ...
                checkout([$class: 'GitSCM',
                    branches: [[name: 'main']],
                    userRemoteConfigs: [[url: 'https://github.com/princeabhijeet/payment-service.git']],
        ...
        stage('Docker: Build Image') {
            steps {
                ...
                sh "docker rmi princeabhijeet/payment-service:latest || true"
                sh "docker build -t princeabhijeet/payment-service:latest ."
        ...
        stage('Docker: Push Image') {
            steps {
                ...
                withDockerRegistry([credentialsId: 'dockerhub_credentials', url: 'https://index.docker.io/v1/']) {
                    sh "docker push princeabhijeet/payment-service:latest"
                }
